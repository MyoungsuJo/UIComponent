...
public class MSEditText extends AppCompatEditText {
    ...
    private void init(){
        ...
        if(inputType == INPUT_TYPE_CAPS_ENG){
            setFilters(new InputFilter[]{new InputFilter.AllCaps()});
            setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD | InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS);
